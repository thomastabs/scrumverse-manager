...
const CollaborativeProjectsList: React.FC = () => {
  ...
  if (collaborativeProjects.length === 0) {
    return (
      <div className="text-center py-6 bg-scrum-card border border-scrum-border rounded-md">
        <Users className="h-12 w-12 mx-auto mb-4 text-scrum-text-secondary opacity-50" />
...
export default CollaborativeProjectsList;
